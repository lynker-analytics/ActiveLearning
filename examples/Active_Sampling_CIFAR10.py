...
lr_patience=15
model_file='models/active_samples_tmp.h5'
csvfile='logs/Active_Sampling_{}_{}_{}.csv'
...
Active_metrics=['NULL', 'Least Confident','Least Margin','Most Entropy','Most and Least Confident','Most Confident']
